...
exports.login = async (req, res) => {
    ...
    try {
        ...
        // Compare the incoming password (plaintext) with the stored hashed password
        const isMatch = await bcrypt.compare(password, user.password); // Corrected bcrypt comparison
        if (!isMatch) {
